...
<head>
    ...
    <!---------Css link------------>
    <link rel="stylesheet" href="style_log__sign-up.css">
                                    ...
                                    <div class="form-control-2">
                                        <label for="section">Section:</label>
                                            <select name="section" id="section">
                                                <!-- This will be dynamically populated based on the selected course -->
                                            </select>
                                    </div>
                                </div>
                            <div class="form-control">
                                ...
                                <button class="btn btn-lg btn-block" type="submit" name="submit" value="Submit">SIGNUP</button>
                            <div class="login">
