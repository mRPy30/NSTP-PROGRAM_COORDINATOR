   ...
   <nav class="sidebar navbar-collapsed" >
    ...
    <!---------End Sidebar--------->
        ...
        <!--Main Content-->
                             ...
                             <div class="col-sm-3">
                                <div class="box1"><a href="student-classes-instructor.php">Instructor</a></div>
                             </div>
                          

                             <div class="col-sm-3"> 
                                <div class="box1"><a href="student-classes-course-materials.php">Course Materials</a></div>
                             </div>
                             <div class="col-sm-3"> 
                                <div class="box1"><a href="student-classes-schedule.php">Schedule</a></div>
                             </div>
                             <div class="col-sm-3"> 
                                <div class="box1"><a href="student-classes-classlist.php">Class List</a></div>
                             </div>
